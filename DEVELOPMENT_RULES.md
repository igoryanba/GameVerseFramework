...
- **Типы**:
    ...
    - 🚧 Требуется улучшение генерации кода для `FunctionCallback` (поддержка специфичных сигнатур) и `Opaque` (например, создание псевдо-типов или использование имени в генерируемых структурах).
